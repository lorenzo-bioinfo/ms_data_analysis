...
def cross_ks(s1, s2, s3, s4, s5, s6, filename):
	tup1 = (s1, s2, s3, s4, s5, s6)
	tup2 = (s1, s2, s3, s4, s5, s6)
	statistiche = []
	for el1 in tup1:
		stat = []
		for el2 in tup2:
	...
	with open('./data/clusterstats_norm/{}_.tsv'.format(filename), 'w') as f:
		f.write('\tGroup1({})\tGroup2({})\tGroup3({})\tGroup4({})\tGroup5({})\tGroup6({})\n'.format(len(s1), len(s2), len(s3), len(s4), len(s5), len(s6)))
...
cross_ks(s1, s2, s3, s4, s5, s6, 'lact')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'vitd')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'age')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'edss_t0')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'edss_t1')
...
s6 = listDiff(s6a, s6b)
#s7 = listDiff(s7a, s7b)
cross_ks(s1, s2, s3, s4, s5, s6, 'delta_edss')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'rel_t0')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'msss')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'brems')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'fss')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'bmi')
...
cross_ks(s1, s2, s3, s4, s5, s6, 'last_rel')
...
#s7 = list(df7['last_rel'].astype(float))
cross_ks(s1, s2, s3, s4, s5, s6, 'les_vol')