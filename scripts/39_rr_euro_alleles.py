...
f = open('./data/snp/tests/alleles_rr_vs_euro.tsv', 'w')
...
df = pd.read_csv('./data/snp/tests/alleles_rr_vs_euro.tsv', sep = '\t')
df_corr = benjamini_hochberg(df, 'p-val')
df_corr.to_csv('./data/snp/tests/alleles_rr_vs_euro_bh.tsv', sep = '\t')
print(df_corr)